...
var back = Alice.Object.fromImage(baseURL.nomalAssets + 'alice/room_basic.png');
back.anchor.set(0.5);
...
var door = Alice.Object.fromImage(baseURL.nomalAssets + 'alice/door.png');
door.anchor.set(0.5);
door.x = myGame.screenWidth / 2;
door.y = myGame.screenHeight / 2 + 5;
door.scale.set(1);
door.name = "door";
door.nextTexture = Alice.Texture.fromImage(baseURL.nomalAssets + 'alice/door_open.png');
...
var key = Alice.Object.fromImage(baseURL.nomalAssets + 'alice/key.png');
key.anchor.set(0.5);
key.x = 900;
key.y = 500;
key.scale.set(0.7);
...
var cat = Alice.Object.fromImage(baseURL.nomalAssets + 'alice/cat.png');
cat.anchor.set(0.5);
cat.x = 250;
cat.y = 500;
cat.scale.set(0.8);
...
var bossAnimationUrl = baseURL.nomalAssets + 'alice/boss/';
var boss = Alice.AnimatedObject.fromImages([bossAnimationUrl + 'boss3_idle1.png',
                                            bossAnimationUrl + 'boss3_idle2.png',
                                            bossAnimationUrl + 'boss3_idle3.png',
                                            bossAnimationUrl + 'boss3_idle4.png']);
boss.anchor.set(0.5);
boss.x = 1000;
...
var back2 = Alice.Object.fromImage(baseURL.nomalAssets + 'alice/backdrop.png');
...
var robot = Alice.Object.fromImage(baseURL.nomalAssets + 'alice/robot.png');
...
var paint = Alice.Object.fromImage(baseURL.nomalAssets + 'alice/whitepaint.png');
...
var cone = Alice.Object.fromImage(baseURL.nomalAssets+'alice/redcone.png');
cone.anchor.set(0.5);
cone.x = 900;
cone.y = 500;
cone.scale.set(1.2);
...
cone.nextTexture = Alice.Texture.fromImage(baseURL.nomalAssets + 'alice/whitecone.png');
