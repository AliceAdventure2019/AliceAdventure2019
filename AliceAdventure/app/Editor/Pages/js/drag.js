...
function minimizeWindow(event) {
  ...
  let targetImg = event.target.closest('#interaction-box-minimize');
  let target = eventTarget.closest('.interaction-box');
  let targetChildren = target.childNodes;
  var minimizeSrc = document
    .getElementById('interaction-box-minimize')
    .getAttribute('min-src');
  var maxmizeSrc = document
    .getElementById('interaction-box-minimize')
