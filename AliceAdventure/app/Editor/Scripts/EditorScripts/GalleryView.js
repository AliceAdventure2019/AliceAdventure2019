...
GalleryView.ImageLibrary = {
  backdrop: [
    ...
    { name: 'Doorway', src: '../../Assets/backdrop/doorway.png' },
    { name: 'Galaxy', src: '../../Assets/backdrop/galaxy.png' },
    { name: 'Hall', src: '../../Assets/backdrop/hall.png' },
    ...
    { name: 'RPIS', src: '../../Assets/backdrop/rpis.png' },
  ...
  character: [
    ...
    { name: 'Steve', src: '../../Assets/character/steve.png' },
  ...
  container: [
    ...
    { name: 'Bag', src: '../../Assets/container/bag2.png' },
  ...
  entrance: [
    ...
    { name: 'Gate', src: '../../Assets/entrance/gate2.png' },
    ...
    { name: 'RPIS Door', src: '../../Assets/entrance/rpisdoor.png' },
  ...
  others: [
    ...
    { name: 'Disk', src: '../../Assets/other/disk.png' },
    ...
    { name: 'Student ID', src: '../../Assets/other/idc.png' },
